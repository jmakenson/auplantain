...
class AdminContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '8889', 'dbname' => 'auplantain', 'user' => 'root', 'password' => 'root', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/Applications/MAMP/htdocs/auplantain/modules/productcomments/src/Entity']);
        $d->addExcludePaths([0 => '/Applications/MAMP/htdocs/auplantain/modules/productcomments/src/Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/Applications/MAMP/htdocs/auplantain/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/Applications/MAMP/htdocs/auplantain/var/cache/prod//doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_451c3a188b9d196858152bbddf4eb66b8337ecdb31727d0034cfd11cf66c190c');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/Applications/MAMP/htdocs/auplantain/var/cache/prod//localization');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => '/Applications/MAMP/htdocs/auplantain/app',
            'kernel.project_dir' => '/Applications/MAMP/htdocs/auplantain',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/auplantain/var/cache/prod/',
            ...
            'ps_cache_dir' => '/Applications/MAMP/htdocs/auplantain/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/MAMP/htdocs/auplantain/var/cache/prod//doctrine/orm/Proxies',
